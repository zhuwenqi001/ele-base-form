...
| 参数 | 说明 | 类型 | 可选值 | 默认值 |
| --- |------|:----:|-----|:-----:|
| itemType | item 类型 | String | [input](#inputType), number, radio, checkbox, select, slider, date, remoteselect | input |
| label | item描述 | String | - | - |
...
2. 依赖关系
    ...
    3. A值作为B的必须参数，使用require，只为Boolean。require为true情况，B不会进行请求、筛选
